...
def profile(request):
    ...
    try:
       ...
       current_semester = get_object_or_404(Semester, is_current_semester=True, session=current_session)
        ...
        raise Http404("Multiple Semesters returned")
    except Semester.DoesNotExist:
        raise Http404("Semester does not exist")
...
class LecturerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "Lecturers | AAU_CNCS"
        return context
...
class StudentListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = "Students | AAU_CNCS"
        return context
